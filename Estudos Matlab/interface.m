...
% Last Modified by GUIDE v2.5 21-Feb-2019 17:58:54
...
handles.f = 0;
handles.t = 0:0.001:1;
handles.estado = 1; %Estado do botão pressionado, 1 ou 2.
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% % display(['Valor da variavél f: ' handles.f]);
% % display(['Botão selecionado é o ' num2str(handles.estado)]);
