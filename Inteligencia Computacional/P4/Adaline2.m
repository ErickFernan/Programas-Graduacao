...
s = 1:392; % Vetor linha de valores aleatórios que tem o tamanho da amostra
...
Amostra_Ent = (Amostra_Treino); % normalizar
...
Ent_teste = [-1*ones(length(Entrada),1) (Entrada)]; 
e = 0;
