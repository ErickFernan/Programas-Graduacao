...
; PELO SISTEMA
	CBLOCK	0x20	;ENDEREÇO INICIAL DA MEMÓRIA DE
		...
		VALOR ;VARIÁVEL RESPONSÁVEL PELO CONTADOR
		TFILTRO ;VARIÁVEL RESPONSÁVEL PELO FILTRO
		TFILTRODEC ;VARIÁVEL RESPONSÁVEL PELO FILTRO DO DECREMENTO  
...
TRAVA
	BTFSC SW4
	GOTO MAIN ;VOLTAR PARA GOTO MAIN SE DER ERRADO
	GOTO TRAVA

TRAVA2
    BTFSC SW4
	GOTO TESTE ;VOLTAR PARA GOTO TESTE SE DER ERRADO
	GOTO TRAVA2
